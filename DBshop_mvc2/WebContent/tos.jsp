...
<jsp:include page="top.jsp"/>
                         <!-------------------------------- 이용약관 ------------------------------> 
                        <form name="frm" action="join.jsp" method="post">
                         <table width=100% align=center class="checkbox_group">
                          <tr>
                           <td align=center>
                     ...
                     제24조(재판권 및 준거법)
                      ...
                      ②“몰”과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
                                 ...
                                 <tr>
                                   <td>
                                     <input type="checkbox" name="check_1" id="check_1" class="normal" >
                                     <label for="check_1">이용약관에 동의합니다. (필수)</label>
                                     <br><br><br><br>
                                   </td>
                                 </tr>
                                 <tr>
                     ...
                     '정보통신망 이용촉진 및 정보보호 등에 관한 법률'의 거래기록 보존 의무에 따른 보존: 1년
                                 ...
                                 <tr>
                                   <td>
                                    <input type="checkbox" name="check_2" id="check_2" class="normal" >
                                    <label for="check_2">개인정보 수집 및 이용에 대한 안내에 동의합니다. (필수)</label>
                                    <br><br><br><br>
                                   </td>
                                 </tr>
                               ...
                               <tr>
                                  <td>
                                    <div>
                                     <font color="#f67001" size=4>03</font> <font size=3>쇼핑정보 수신 동의</font>
                                    </div>
                                 </td>
                               </tr>
                               <tr>
                                ...
                                <tr>
                                  <td>
                                    ...
                                    <label for="check_3">SMS 수신을 동의하십니까? (선택)</label>
                         ...
                         <tr>
                         	<td style="text-align: center;">
                         		<input class="tos_btn" type="button" value="취소" onclick="history.back()" >
          						<!-- <input type="button" value="동의" onclick="location.href='Join'"> -->
          						<input class="tos_btn" type="button" value="동의" onclick="checkinfo()">
          ...
          <script>
            ...
            var chk1 = document.frm.check_1;
            var chk2 = document.frm.check_2;
