...
public class BoardUpadteProcHandler implements DbshopHandler {
	...
	public String process(HttpServletRequest request, HttpServletResponse response)
		...
		int productNum = Integer.parseInt(mrequest.getParameter("productNum"));
		...
		Dao dao = new Dao();
		dao.boardInsert(productNum, kind, price, name, contents, image);
